...
y=622
y=block('1', 'Collect, then enter', 'For the main entry offer: exchange your visit-day code at the <b>Hagia Sophia History &amp; Experience Museum kiosk</b> near the Hippodrome. Then walk to Hagia Sophia and follow the signed visitor-gallery entrance. Other offers may use direct QR delivery or a guide meeting point. Your voucher has the instructions.', y)
...
text('Independent guide. Sources reviewed 9 September 2026.<br/>Sources: DEM Museums, Blue Mosque visitor guide,<br/>National Palaces and Kult\u00fcr Istanbul. Links in the planner.<br/>Maps and booking pages need an internet connection.',60,8,muted,x=106,width=285,leading=11)
c.showPage();c.save()
print(OUT)
